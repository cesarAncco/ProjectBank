...
/**
 * CreditRepositoryImpl.class for the implementation of CreditRepository
 * The CreditRepositoryJPA is used to be able to use the basic functions of JPA, it makes it easier for us
 */
