...
/**
 * ClientRepositoryImpl.class for the implementation of ClientRepository
 * The ClientRepositoryJPA is used to be able to use the basic functions of JPA, it makes it easier for us
 */
